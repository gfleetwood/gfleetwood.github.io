...
**Summary**: The main pipeline involved feature engineering to create a feature for distance, another for the product of x-y coordinates, scaling numeric features, and dummying the sole categorical column.

**Final Result**: A 5-fold cross validated untuned Logistic Regression model with a 23% accuracy score compared to a naive baseline of 5.6%.
<br/>

**Prostate Cancer**: [[Blog]](https://github.com/gfleetwood/prostate-cancer/blob/master/reports/prostate_cancer.md)

**Description**: Analysis of a small data set of 12,600 gene markers to find patterns which indicate the presence or absence of a tumor. 
